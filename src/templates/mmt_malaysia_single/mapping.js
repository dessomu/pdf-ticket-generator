...
const mapping = {
  fields: {
    ...
    departurePassengerName: { x: 50, y: 552, fontSize: 11, font: "regular",color:COLORS.darkGrey, width: 280, height: 12 },
    returnPassengerName: { x: 50, y: 288, fontSize: 11, font: "regular",color:COLORS.darkGrey, width: 280, height: 12 },
